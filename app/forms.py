...
class RegistrationForm(FlaskForm):
    ...
    password2 = PasswordField('Mot de passe', validators=[DataRequired("Le champ est vide"),
                                                          EqualTo('password', message="Les 2 mots de passe ne correspondent pas")])
...
class ResetPasswordForm(FlaskForm):
    password = PasswordField('Mot de passe', validators=[DataRequired()])
    password2 = PasswordField('Mot de passe', validators=[DataRequired(),
                                                          EqualTo('password', message="Les 2 mots de passe ne correspondent pas")])
    submit = SubmitField('Changer son mot de passe')